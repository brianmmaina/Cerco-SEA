      ...
      {hasEvents && (
        <View
          style={[
            styles.eventDot,
            {
              backgroundColor: isSelected ? theme.colors.textInverse : theme.colors.primary,
            },
          ]}
        />
      )}
  ...
  return (
    ...
    >
        ...
        <View style={styles.headerActions}>
          <TouchableOpacity
            style={[
              ...
              {
                backgroundColor:
                  selectedView === 'week' ? theme.colors.primary : theme.colors.surface,
                borderColor: theme.colors.border,
              },
            ]}
          ...
          >
            <Text
              style={[
                ...
                {
                  color:
                    selectedView === 'week' ? theme.colors.textInverse : theme.colors.textPrimary,
                },
              ]}
            >
              Week
          ...
          <TouchableOpacity
            style={[
              ...
              {
                backgroundColor:
                  selectedView === 'month' ? theme.colors.primary : theme.colors.surface,
                borderColor: theme.colors.border,
              },
            ]}
          ...
          >
            <Text
              style={[
                ...
                {
                  color:
                    selectedView === 'month' ? theme.colors.textInverse : theme.colors.textPrimary,
                },
              ]}
            >
              Month
      ...
      >
        ...
        >
          <Text style={[styles.todayButtonText, { color: theme.colors.textInverse }]}>Today</Text>
        </TouchableOpacity>
          ...
          <View style={styles.monthGrid}>
            ...
            <View style={styles.monthDayHeaders}>
              {['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'].map((day, index) => (
                <Text
                  key={index}
                  style={[styles.monthDayHeader, { color: theme.colors.textSecondary }]}
                >
                  {day}
                </Text>
              ))}
